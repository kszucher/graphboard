...
def test_expression_safety_and_rules() -> None:
    from app.modules.graphs.expressions import parse_expression
...
def test_parse_comparison_expression() -> None:
    from app.modules.graphs.expressions import parse_comparison_expression
...
def test_translate_polars_to_python() -> None:
    from app.modules.graphs.expressions import translate_polars_to_python
