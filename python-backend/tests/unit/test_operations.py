...
def test_create_definer_variable_success():
    flow = {
        "nodes": [{"id": "definer_1", "node_type": "DEFINER", "ref_id": "op_definer_1"}],
        "operations": {"definer": [{"id": "op_definer_1", "variables": []}]},
    }
...
def test_delete_definer_variable():
    flow = {
        "operations": {
            "definer": [
                {"id": "op_definer_1", "variables": [{"id": "var_x", "key": "x", "type": "number", "default_value": 1}]}
            ]
        }
    }
...
def test_create_logical_assignment_success():
    flow = {
        "nodes": [
            {"id": "definer_1", "node_type": "DEFINER", "ref_id": "op_def_1"},
            {"id": "assigner_1", "node_type": "LOGICAL_ASSIGNER", "ref_id": "op_assign_1"},
        ],
        "operations": {
            "definer": [
                {"id": "op_def_1", "variables": [{"id": "var_x", "key": "x", "type": "number", "default_value": 0}]}
            ],
            "logical": [{"id": "op_assign_1", "assignments": []}],
        },
    }
            ...
            "definer": [
                {
                    "id": "op_def_1",
                    "variables": [
                        {"id": "var_x", "key": "x", "type": "number", "default_value": 0},
                        {"id": "var_y", "key": "y", "type": "string", "default_value": ""},
                    ],
                }
            ],
            "logical": [
                {
                    "id": "op_assign_1",
                    "assignments": [{"id": "asgn_1", "target_var_key": "x", "value_type": "number", "value": 10}],
                }
            ],
        }
    }
...
def test_delete_logical_assignment():
    flow = {
        "operations": {
            "logical": [{"id": "op_assign_1", "assignments": [{"id": "asgn_1", "target_var_key": "x", "value": 10}]}]
        }
    }
