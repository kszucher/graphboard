    ...
    state = {
        ...
        "agent_checklist": {
            "tool_calls": [
                ...
                {"name": "reroute_edge", "arguments": '{"source": "start", "new_target": "new_assigner"}'},
            ]
        },
        "initial_flow_data": {
    ...
    state = {
        ...
        "agent_checklist": {
            "tool_calls": [
                ...
                {"name": "reroute_edge", "arguments": '{"source": "start", "new_target": "switch_node"}'},
                {"name": "reroute_edge", "arguments": '{"source": "switch_node", "branch": "No", "new_target": null}'},
            ]
        },
        "initial_flow_data": {
    ...
    state = {
        ...
        "agent_checklist": {
            "tool_calls": [
                {
                    "name": "upsert_node",
                    "arguments": '{"id": "switch_node", "node_type": "LOGICAL_SWITCH", "config": {"branches": [{"label": "Yes", "target": "end"}]}}',
                },
                {"name": "reroute_edge", "arguments": '{"source": "start", "new_target": "switch_node"}'},
                {"name": "reroute_edge", "arguments": '{"source": "switch_node", "new_target": "end"}'},
            ]
        },
        "initial_flow_data": {
            "nodes": [{"id": "end", "node_type": "LOGICAL_ASSIGNER", "assignments": []}],
